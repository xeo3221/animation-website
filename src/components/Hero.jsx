...
const Hero = () => {
  ...
  const [nextVideoSrc, setNextVideoSrc] = useState(getVideoSrc(2));
  ...
  const handleMiniVideoClick = () => {
    ...
    setNextVideoSrc(getVideoSrc((upcomingVideoIndex % totalVideos) + 1));
  };
    ...
    () => {
      if (hasClicked) {
        ...
        gsap.to("#next-video", {
          ...
          ease: "power1.inOut",
          onStart: () => {
            // Tu zmieniamy źródło dużego video na poprzednie małe
            const nextVideo = document.querySelector("#next-video");
            nextVideo.src = getVideoSrc(upcomingVideoIndex);
    ...
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        <div>
          ...
          />
          <video
            src={getVideoSrc(currentIndex)} // Changed this line
            autoPlay
            loop
            muted
